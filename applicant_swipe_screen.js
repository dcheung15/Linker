/*
The swipe screen job applicants will see to apply to jobs.
...
var dummyJobs = generateJobs(dummy_profile_json); //generate dummy job information to display in cards

var applied_jobs = Array(); //list of jobs applied to
...
function generateJobs(profile_data) {
    ...
    var num_jobs = 20;// total number of jobs generated by generateJobs()

    var jobs = new Array(num_jobs); //Object(); 
